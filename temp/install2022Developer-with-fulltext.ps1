...
$sqlInstallArgs = "/qs /ACTION=Install /FEATURES=SQL,FULLTEXT /INSTANCENAME=$instanceName /ENU /IACCEPTSQLSERVERLICENSETERMS /SQLSYSADMINACCOUNTS=$user /UPDATEENABLED=false /USEMICROSOFTUPDATE=false"
